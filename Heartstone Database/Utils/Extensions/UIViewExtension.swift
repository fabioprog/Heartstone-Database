...
extension UIView {
    ...
    func showLoadingView() {
        ...
        activityIndicator.color = ColorAsset.primaryText.color
    ...
    @discardableResult public func widthAnchor(to anchor: NSLayoutDimension) -> Self {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    @discardableResult public func heightAnchor(to anchor: NSLayoutDimension) -> Self {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    func setGroupedAccessibility(labels: [UILabel]) {
        isAccessibilityElement = true
        let label = labels.map({ $0.text ?? "" }).joined(separator: " ")
        accessibilityLabel = label
        accessibilityElements = labels
